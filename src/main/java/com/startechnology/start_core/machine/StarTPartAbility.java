...
public class StarTPartAbility {
    ...
    /* Enables a climate hatch to be used on this machine */
    public static final PartAbility CLIMATE_HATCH = new PartAbility("climate_hatch");
    ...
    public static final PartAbility MODULAR_AUTO_SCALING_TERMINAL_CONDUIT = new PartAbility(
            "modular_auto_scaling_terminal_conduit");

    /* Enables the usage of modular auto scaling node conduits in this machine */
    public static final PartAbility MODULAR_AUTO_SCALING_NODE_CONDUIT = new PartAbility(
            "modular_auto_scaling_node_conduit");
