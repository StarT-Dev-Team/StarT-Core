...
public class StarTParallelHatches {
    ...
    public static final MachineDefinition[] ABSOLUTE_PARALLEL_HATCH = StarTMachineUtils.registerTieredMachines(
            "absolute_parallel_hatch",
            ...
            (tier, builder) -> builder
                    ...
                    .workableTieredHullModel(
                            StarTCore.resourceLocation("block/parallel/absolute_parallel_hatch_mk" + (tier - 8)))
                    .tooltips(Component
                            .translatable("start_core.machine.absolute_parallel_hatch_mk" + (tier - 8) + ".tooltip"))
    ...
    public static final MachineDefinition[] PARALLEL_HATCH = StarTMachineUtils.registerTieredMachines("parallel_hatch",
            ...
            (tier, builder) -> builder
                    ...
                    .workableTieredHullModel(
                            StarTCore.resourceLocation("block/parallel/parallel_hatch_mk" + (tier - 4)))
