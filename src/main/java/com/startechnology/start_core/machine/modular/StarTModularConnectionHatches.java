...
public class StarTModularConnectionHatches {
    ...
    private static class StarTModularEnergyOverlay {
        ...
        public StarTModularEnergyOverlay(int amperage) {
            this.tintedPart = StarTCore
                    .resourceLocation("block/overlay/modular/overlay_energy_" + amperage + "a_tinted");
            ...
            this.inPartEmissive = StarTCore
                    .resourceLocation("block/overlay/modular/overlay_energy_" + amperage + "a_in_emissive");
            this.outPart = StarTCore.resourceLocation("block/overlay/modular/overlay_energy_" + amperage + "a_out");
            this.outPartEmissive = StarTCore
                    .resourceLocation("block/overlay/modular/overlay_energy_" + amperage + "a_out_emissive");
        }
    }
    ...
    public static MachineBuilder.ModelInitializer createAutoScalingHatchModel(IO io) {
        return (ctx, prov, builder) -> {
            ...
            ResourceLocation overlayOutTexture = StarTCore
                    .resourceLocation("block/overlay/modular/overlay_scaling_out");
            ResourceLocation overlayOutEmissive = StarTCore
                    .resourceLocation("block/overlay/modular/overlay_scaling_out_emissive");
            ResourceLocation overlayInEmissive = StarTCore
                    .resourceLocation("block/overlay/modular/overlay_scaling_in_emissive");
    ...
    public static MachineBuilder.ModelInitializer createNonPoweredModularHatchModel(IO io) {
        return (ctx, prov, builder) -> {
            ...
            ResourceLocation overlayOutTexture = StarTCore
                    .resourceLocation("block/overlay/modular/overlay_interface_out");
            ResourceLocation overlayOutEmissive = StarTCore
                    .resourceLocation("block/overlay/modular/overlay_interface_out_emissive");
            ResourceLocation overlayInEmissive = StarTCore
                    .resourceLocation("block/overlay/modular/overlay_interface_in_emissive");
    ...
    public static MachineDefinition[] registerPowerModularConnectionHatch(int amperage, IO io, PartAbility ability,
                                                                          PartAbility conduitAbility,
                                                                          int... tiers) {
        ...
        return StarTMachineUtils.registerTieredMachines(amperage + "a_modular_conduit_" + name,
                ...
                (tier, builder) -> builder
                        ...
                        .tooltips(
                                ...
                                Component.translatable(
                                        "gtceu.universal.tooltip.amperage_" + (io == IO.IN ? "in" : "out"), amperage),
    ...
    public static final MachineDefinition MODULAR_AUTO_SCALING_CONDUIT_NODE = registerAutoScalingModularConnectionHatch(
            IO.IN,
            StarTPartAbility.MODULAR_NODE, StarTPartAbility.MODULAR_AUTO_SCALING_NODE_CONDUIT);

    public static final MachineDefinition MODULAR_AUTO_SCALING_CONDUIT_TERMINAL = registerAutoScalingModularConnectionHatch(
            IO.OUT,
