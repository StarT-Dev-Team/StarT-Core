    ...
    public static MultiblockMachineBuilder makeDreamlinkNode(String name, Integer range, Integer connections, Boolean checkDimension) {
        ...
        public static final MultiblockMachineDefinition DREAM_LINK_NODE = makeDreamlinkNode("dream_link_node", 16, 16, true)
            .pattern(definition -> FactoryBlockPattern.start()
                ...
                .aisle(" CEEEEEC", "   E E  ", "   E E  ", "B  EEE  ", "   E E  ", "   E E  ", " CEEEEEC", "        ", "        ", "        ", "        ")
                .aisle(" CEEEEEC", "    F   ", "    F   ", "   EFE  ", "B   F   ", "    F   ", " CEEFEEC", "  E   E ", "    F   ", "  F   F ", "        ")
                .aisle(" CEEEEEC", "   E E  ", "   E E  ", "   E@E  ", "   E E  ", "B  E E  ", " CEEEEEC", "        ", "        ", "        ", "        ")
        ...
        public static final MultiblockMachineDefinition ONEIRIC_RELAY = makeDreamlinkNode("oneiric_relay", 32, 64, true)
            .pattern(definition -> FactoryBlockPattern.start()
                ...
                .aisle(" CFFFFFC ", "   F F   ", "   F F   ", "B  FFF   ", "   F F   ", "   F F  B", " CFFFFFC ", "         ", "B        ", "         ", "        B", "         ", " CFDDDFC ", "         ", "         ", "         ")
                .aisle(" CFFFFFC ", "    D    ", "    D    ", "   FDF   ", "B   D   B", "    D    ", " CFFDFFC ", "  F   F  ", "  F   F  ", "B D   D B", "  F   F  ", "  F   F  ", " CFDDDFC ", "  F   F  ", " D     D ", "         ")
        ...
        public static final MultiblockMachineDefinition DAYDREAM_SPIRE = makeDreamlinkNode("daydream_spire", 64, -1, true)
            .pattern(definition -> FactoryBlockPattern.start()
                ...
                .aisle(" DFFFD   DFFFFFD   DFFFD ", "   F       F F       F   ", "C  F       F F    C  F   ", "  FFF   C  FFF      FFF  ", "   F  C    F F       F  C", "   F       F F  C    F   ", "C        DFFFFFD  C      ", "                         ", " B   B  C          B   B ", "                         ", "      B         C B      ", "                         ", "         DFBBBFD         ", "                         ", "                         ", "                         ", "                         ")
                .aisle(" DFFFDDDDDFFFFFDDDDDFFFD ", "  FEF       B       FEF  ", "  FEF       B       FEF  ", "C FEF C    FBF    C FEF C", "  FEF   C   B   C   FEF  ", "  FEF       B       FEF  ", "   E     DFFBFFD     E   ", "C  E  C   F   F   C  E  C", " B E B    F   F    B E B ", "   E    C B   B C    E   ", "      B   F   F   B      ", "   B      F   F      B   ", " B   B   DFBBBFD   B   B ", "          F   F          ", "         B     B         ", "       B         B       ", "                         ")
