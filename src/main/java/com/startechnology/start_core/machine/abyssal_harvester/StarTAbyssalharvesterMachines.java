...
public class StarTAbyssalharvesterMachines {
    ...
    public static MultiblockMachineDefinition ABYSSAL_HARVESTER = START_REGISTRATE
        ...
        .appearanceBlock(() -> StarTMachineUtils.getKjsBlock(("draconic_casing")))
        ...
        .pattern(definition -> FactoryBlockPattern.start()
            ...
            .aisle("             ", "   OOOOOOO   ", "  D  BGG  D  ", " g   BGG     ", " g    G      ", "           D ", "           D ", " D           ", " D           ", "           D ", "           D ", " D           ", " D    G      ", "     GGD   g ", "  D  GGB  D  ", "   OOOOOOO   ", "             ")
            ...
            .where('D', Predicates.blocks(StarTMachineUtils.getKjsBlock("draconic_casing")))
            ...
            .where('O', Predicates.blocks(StarTMachineUtils.getKjsBlock("draconic_casing"))
        ...
        .workableCasingRenderer(KubeJS.id("block/casings/ultimate_multis/draconic_casing"),
