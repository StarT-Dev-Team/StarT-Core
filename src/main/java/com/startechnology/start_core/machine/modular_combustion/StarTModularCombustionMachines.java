...
public class StarTModularCombustionMachines {
    ...
    public static final MultiblockMachineDefinition T1_COMBUSTION_MODULE = START_REGISTRATE
            ...
            .tooltips(
                    ...
                    Component.translatable("block.start_core.t1_combustion_module_d1",
                            FormattingUtil.formatNumbers(100)),
    ...
    public static final MultiblockMachineDefinition T2_COMBUSTION_MODULE = START_REGISTRATE
            ...
            .tooltips(
                    ...
                    Component.translatable("block.start_core.t2_combustion_module_d1",
    ...
    public static final MultiblockMachineDefinition MODULAR_COMBUSTION_FRAME = START_REGISTRATE
            .multiblock("modular_combustion_frame",
                    (holder) -> new ModularFrameBoosting(holder, StarTCore.resourceLocation("uv_combustion_module"),
                            StarTCore.resourceLocation("uev_combustion_module"),
                            StarTCore.resourceLocation("luv_combustion_module"),
                            StarTCore.resourceLocation("zpm_combustion_module")))
