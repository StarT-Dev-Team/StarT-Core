...
public class StarTGCropItems {
    ...
    public static final ItemEntry<ComponentItem> GCROP_BLACK_DYE = START_REGISTRATE
            .item("black_dye_gcrop", ComponentItem::create)
            .lang("§3Black GCrop")
            .properties(prop -> prop.stacksTo(16))
    ...
    public static final ItemEntry<ComponentItem> GCROP_RED_DYE = START_REGISTRATE
            .item("red_dye_gcrop", ComponentItem::create)
            .lang("§3Red GCrop")
            .properties(prop -> prop.stacksTo(16))
            .onRegister(attach(new StarTGCropBehaviour(
                    0,
    ...
    public static final ItemEntry<ComponentItem> GCROP_GREEN_DYE = START_REGISTRATE
            .item("green_dye_gcrop", ComponentItem::create)
            .lang("§3Green GCrop")
            .properties(prop -> prop.stacksTo(16))
            .onRegister(attach(new StarTGCropBehaviour(
                    0,
    ...
    public static final ItemEntry<ComponentItem> GCROP_BROWN_DYE = START_REGISTRATE
            .item("brown_dye_gcrop", ComponentItem::create)
            .lang("§3Brown GCrop")
            .properties(prop -> prop.stacksTo(16))
            .onRegister(attach(new StarTGCropBehaviour(
                    0,
    ...
    public static final ItemEntry<ComponentItem> GCROP_BLUE_DYE = START_REGISTRATE
            .item("blue_dye_gcrop", ComponentItem::create)
            .lang("§3Blue GCrop")
            .properties(prop -> prop.stacksTo(16))
            .onRegister(attach(new StarTGCropBehaviour(
                    0,
    ...
    public static final ItemEntry<ComponentItem> GCROP_PURPLE_DYE = START_REGISTRATE
            .item("purple_dye_gcrop", ComponentItem::create)
            .lang("§3Purple GCrop")
            .properties(prop -> prop.stacksTo(16))
            .onRegister(attach(new StarTGCropBehaviour(
                    0,
    ...
    public static final ItemEntry<ComponentItem> GCROP_CYAN_DYE = START_REGISTRATE
            .item("cyan_dye_gcrop", ComponentItem::create)
            .lang("§3Cyan GCrop")
            .properties(prop -> prop.stacksTo(16))
            .onRegister(attach(new StarTGCropBehaviour(
                    0,
    ...
    public static final ItemEntry<ComponentItem> GCROP_LIGHT_GRAY_DYE = START_REGISTRATE
            .item("light_gray_dye_gcrop", ComponentItem::create)
    ...
    public static final ItemEntry<ComponentItem> GCROP_GRAY_DYE = START_REGISTRATE
            .item("gray_dye_gcrop", ComponentItem::create)
            .lang("§3Gray GCrop")
            .properties(prop -> prop.stacksTo(16))
            .onRegister(attach(new StarTGCropBehaviour(
                    0,
    ...
    public static final ItemEntry<ComponentItem> GCROP_PINK_DYE = START_REGISTRATE
            .item("pink_dye_gcrop", ComponentItem::create)
            .lang("§3Pink GCrop")
            .properties(prop -> prop.stacksTo(16))
            .onRegister(attach(new StarTGCropBehaviour(
                    0,
    ...
    public static final ItemEntry<ComponentItem> GCROP_LIME_DYE = START_REGISTRATE
            .item("lime_dye_gcrop", ComponentItem::create)
            .lang("§3Lime GCrop")
            .properties(prop -> prop.stacksTo(16))
            .onRegister(attach(new StarTGCropBehaviour(
                    0,
    ...
    public static final ItemEntry<ComponentItem> GCROP_YELLOW_DYE = START_REGISTRATE
            .item("yellow_dye_gcrop", ComponentItem::create)
            .lang("§3Yellow GCrop")
            .properties(prop -> prop.stacksTo(16))
            .onRegister(attach(new StarTGCropBehaviour(
                    0,
    ...
    public static final ItemEntry<ComponentItem> GCROP_LIGHT_BLUE_DYE = START_REGISTRATE
            .item("light_blue_dye_gcrop", ComponentItem::create)
    ...
    public static final ItemEntry<ComponentItem> GCROP_MAGENTA_DYE = START_REGISTRATE
            .item("magenta_dye_gcrop", ComponentItem::create)
            .lang("§3Magenta GCrop")
            .properties(prop -> prop.stacksTo(16))
            .onRegister(attach(new StarTGCropBehaviour(
                    0,
    ...
    public static final ItemEntry<ComponentItem> GCROP_ORANGE_DYE = START_REGISTRATE
            .item("orange_dye_gcrop", ComponentItem::create)
            .lang("§3Orange GCrop")
            .properties(prop -> prop.stacksTo(16))
            .onRegister(attach(new StarTGCropBehaviour(
                    0,
    ...
    public static final ItemEntry<ComponentItem> GCROP_WHITE_DYE = START_REGISTRATE
            .item("white_dye_gcrop", ComponentItem::create)
            .lang("§3White GCrop")
            .properties(prop -> prop.stacksTo(16))
            .onRegister(attach(new StarTGCropBehaviour(
                    0,
