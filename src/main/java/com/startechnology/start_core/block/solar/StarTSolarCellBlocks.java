...
public class StarTSolarCellBlocks {
    ...
    public static NonNullBiConsumer<DataGenContext<Block, StarTSolarCell>, RegistrateBlockstateProvider> createSolarCellModel(StarTSolarCellType solarCellType) {
        ...
        return (ctx, prov) -> prov.simpleBlock(ctx.getEntry(), prov.models()
                ...
                .texture("side",
                        StarTCore.resourceLocation("block/solar/%s_side".formatted(isLowTier ? "low" : "high")))
                .texture("bottom",
                        StarTCore.resourceLocation("block/solar/%s_bottom".formatted(isLowTier ? "low" : "high"))));
    }
    ...
    public static final BlockEntry<StarTSolarCell> LUV_SOLAR_CELL = createSolarCellBlock(
            StarTSolarCells.LUV_SOLAR_CELL);
    public static final BlockEntry<StarTSolarCell> ZPM_SOLAR_CELL = createSolarCellBlock(
            StarTSolarCells.ZPM_SOLAR_CELL);
    public static final BlockEntry<StarTSolarCell> UV_SOLAR_CELL = createSolarCellBlock(StarTSolarCells.UV_SOLAR_CELL);
    public static final BlockEntry<StarTSolarCell> UHV_SOLAR_CELL = createSolarCellBlock(
            StarTSolarCells.UHV_SOLAR_CELL);
    public static final BlockEntityEntry<BlockEntity> START_SOLAR_CELL_BLOCK_ENTITY = START_REGISTRATE
            .blockEntity("solar_cell",
                    (type, pos, blockState) -> new StarTSolarCellBlockEntity(type, pos, blockState, 0))
