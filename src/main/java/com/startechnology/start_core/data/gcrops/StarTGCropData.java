...
public class StarTGCropData {
    ...
    public static void init() {
        ...
        new StarTGCropData("nether_air", "Gnaphalium Caelitcher", LIQUID, "one", Charred, Crystalline, Illuminating,
                Sulfuric);

        new StarTGCropData("ender_air", "Gnaphalium Caelinanis", LIQUID, "two", Fluorescent, Crystalline, Illuminating,
                Aetheric);
        ...
        // Tier 7
        new StarTGCropData("titanite", "Psoralidium Cuneus", ORE, "three", Metallic, Shiny, Mineralic, Aetheric,
                Energetic, Siliceous);

        new StarTGCropData("xenotime", "Psoralidium Vanonor", ORE, "four", Vibrant, Tough, Crystalline, Shiny,
                Illuminating, Sulfuric, Energetic, Apothic, Siliceous);

        new StarTGCropData("zapolite", "Psoralidium ", ORE, "three", Charred, Vibrant, Fluorescent, Metallic, Coarse,
