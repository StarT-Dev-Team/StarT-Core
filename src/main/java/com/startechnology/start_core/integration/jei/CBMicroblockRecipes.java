    ...
    public static void registerCategoryExtension(IVanillaCategoryExtensionRegistration registration) {
        ...
        craftingCategory.addCategoryExtension(
                ...
                recipe -> new ICraftingCategoryExtension() {
                    ...
                    @Override
                    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, @NotNull ICraftingGridHelper helper,
                                          @NotNull IFocusGroup focus) {
                        var resultItem = getResultItem(recipe);
                        var replacementResult = CBMicroblockUtils.convertToMaterials(materials, resultItem)
                                .orElseGet(() -> List.of(resultItem));
