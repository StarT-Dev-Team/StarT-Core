...
public class ResetNBT {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapelessNBTClearingRecipe(provider, "component_data_core",
        ...
        VanillaRecipeHelper.addShapelessNBTClearingRecipe(provider, "mechanical_memory_card",
